...
const th                = msg => new Error(`securityjwt.js: ` + msg);
    ...
    (function (val, type) {
        ...
        if ( type === 'number' && ! Number.isNaN(val) ) {
            ...
            if (val < 4) {
                ...
                throw th(`value in field 'rememberme' should be bigger than 4 seconds if it's integer`);
            }
            ...
            if ( half < opt.rememberme ) {
                ...
                throw th(`expire should be at least 2x bigger than rememberme, current values are: ` + JSON.stringify({
                    expire      : opt.expire,
                    half,
            ...
            throw th(`field 'rememberme' should be false or integer`);
        }
